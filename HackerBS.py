...
#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To HackerBoyBS
...
\033[1;96m─────────────────────────────────────────────────────────
  ...
  \033[1;96m:▒▒▒▒▒▒\033[1;93m+923162518126 \033[1;96m▒▒▒▒▒▒▒▒▒▒▒:::::\033[1;92m♡
...
\033[1;95m▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌
   ...
   \033[1;92m███████▒▒Welcome To HackerBoyBS team▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mA.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mHacker BoyBS
\033[1;94mHacker\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mHackerBoyBS
\033[1;94mWTelgrame\033[1;91m: \033[1;91m@HackerBoyBS
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mA.CREATIONS\033[1;95m♡╰───•◈•───╯♡"""
jalan('    \033[1;96m............ HackerBoyBS...............:')
jalan("\033[1;95m   ┈┈┈STAY HOME   ☠️ ")
jalan('\033[1;92m   ┈┈┈STAY SAFE   ☠️ ')
jalan('\033[1;93m   ┈┈┈I love you Pakistan girl☠️ ')
jalan("\033[1;96m   ┈┈┈best hacker in Pakistan HackerBoyBS❤ ")
print "\033[1;91m♡─────────♡\033[1;96mLogin To A-C\033[1;95m♡──•◈•──╯♡"

CorrectUsername = "Hacker"
CorrectPassword = "BoyBS"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: Hacker BoyBS 
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCiGYAambfzTVAlDs5cEyGsQ')
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Hacker_BoyBS
	print logo
...
def pilih_super():
	...
	print "\033[1;95m♡───────•◈•──────♡\033[1;96mA.creations\033[1;95m♡──────•◈•────♡"
	jalan(' \033[1;93m ........Cloning Start plzzz Wait HackerBoyBS.......... ')
	print "\033[1;95m♡───────•◈•──────♡\033[1;96mA.creations\033[1;95m♡──────•◈•────♡"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mA.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By HackerBoyBS ---•◈•---»" #Dev:Hacker_BoyBS
	...
	print """
            ...
            ╚════════════════╝
♡──────────────•◈•──────────────♡.
: \033[1;96m ....HackerBoyBS............ \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                telgrame 
               +HackerBoyBS"""
